...
function initDataStorage() {
  ...
  dataPath = path.join(userDataDir, 'user-data.json');
  encryptionKeyPath = path.join(userDataDir, '.encryption-key');
...
class ReportGenerator {
  ...
  async generateVarianceReport() {
    ...
    console.log('\n>>> AFTER FETCH - week1 keys:', Object.keys(week1));
    console.log('>>> week1.dateRange:', week1.dateRange);
    console.log('>>> week1.success:', week1.success);
    ...
    const metricsToCheck = ['publisher_rpv'];
    ...
    console.log('DEBUG week1:', { success: week1.success, dateRange: week1.dateRange });
    console.log('DEBUG week2:', { success: week2.success, dateRange: week2.dateRange });
    console.log('DEBUG week3:', { success: week3.success, dateRange: week3.dateRange });
...
app.get('/api/variance-report', async (req, res) => {
  try {
    ...
    console.log('weekRanges:', JSON.stringify(report.weekRanges, null, 2));
    console.log('Number of sites:', report.sites?.length || 0);
    console.log('===================================\n');
...
app.get('/api/low-rpv-report', async (req, res) => {
  try {
    ...
    console.log('\n=== SENDING LOW RPV REPORT TO FRONTEND ===');
    console.log('weekRanges:', JSON.stringify(report.weekRanges, null, 2));
    console.log('Number of sites:', report.sites?.length || 0);
    console.log('RPV Threshold:', report.rpvThreshold);
    console.log('==========================================\n');
...
app.get('/api/no-activity-report', async (req, res) => {
  try {
    ...
    console.log('\n=== SENDING NO ACTIVITY REPORT TO FRONTEND ===');
    console.log('dateRanges:', JSON.stringify(report.dateRanges, null, 2));
    console.log('Number of inactive sites:', report.sites?.length || 0);
    console.log('==============================================\n');
...
// Start server
function startServer(port, electronAppInstance) {
  electronApp = electronAppInstance;
...
if (require.main !== module) {
  ...
  console.log('Cannot run in standalone mode - requires Electron app instance');
  process.exit(1);
}
